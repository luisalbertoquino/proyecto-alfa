...
Con tests automatizados y respaldos ya funcionando de verdad en el droplet, lo único que falta para cerrar el sprint de 30 días es un dato de negocio, no algo técnico:
